...
function Header() {
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-0 h-20 flex items-center justify-between">
        <motion.div
        ...
        <div className="flex items-center space-x-4">
          <Link to='/login'>
            <button
              className="cursor-pointer group relative bg-white hover:bg-zinc-300 text-black font-semibold text-sm px-6 py-3 rounded-full transition-all duration-200 ease-in-out shadow hover:shadow-lg"
            >
