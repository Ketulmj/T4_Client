    ...
    <div className="glass-effect rounded-xl backdrop-blur-md border border-[#4D7CFF]/20 shadow-md hover-glow">

      {
        ...
        <div className='fixed z-10 w-full -top-20'>
          {timeTable.length <= 0 ? <p className='flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm w-full glass-effect text-white text-lg font-semibold tracking-tight'>There is no timetable generated by you</p> :
            <TimetableDialog
              isOpen={true}
      ...
      {isLoading ? <div className="w-12 h-12 mx-auto my-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div> :
        <>
          {ttMetaData.length <= 0 ? <p className='flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm w-full glass-effect text-white text-lg font-semibold tracking-tight'>There is no timetable generated by you</p> :
            <>
