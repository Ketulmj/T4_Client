...
const OrganizationView = ({ orgId }) => {
  ...
  const handleTimetableClick = async (className) => {
    setIsLoading(true);
    try {
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/get/timetable?class=${className}&orgId=${orgId}`);
  ...
  return (
    <>
      ...
      <div className="glass-effect rounded-xl backdrop-blur-md border border-[#4D7CFF]/20 shadow-md hover-glow">
        {
          showTT &&
          <div className='fixed z-100 w-full -top-30'>
